    ...
    <div class="row g-0 justify-content-end">
            ...
            <div class="header-carousel owl-carousel bg-light py-5">
                <div class="row g-0 header-carousel-item align-items-center">
                    <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                        <img src="{{asset('assets/frontend/img/carousel-1.png')}}" class="img-fluid w-100" alt="Image">
                    </div>
                    <div class="col-xl-6 carousel-content p-4">
                        <h4 class="text-uppercase fw-bold mb-4 wow fadeInRight" data-wow-delay="0.1s"
                            style="letter-spacing: 3px;">Save Up To A Rs 400</h4>
                ...
                <div class="row g-0 header-carousel-item align-items-center">
                    <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                        <img src="{{asset('assets/frontend/img/carousel-2.png')}}" class="img-fluid w-100" alt="Image">
                    </div>
                    <div class="col-xl-6 carousel-content p-4">
                        <h4 class="text-uppercase fw-bold mb-4 wow fadeInRight" data-wow-delay="0.1s"
        ...
        <div class="col-12 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay="0.1s">
            <div class="carousel-header-banner h-100">
                <img src="{{asset('assets/frontend/img/purushottam.jpeg')}}" class="img-fluid w-100 h-100" style="object-fit: cover;" alt="Image">
                <div class="carousel-banner-offer">
                    <p class="bg-primary text-white rounded fs-5 py-2 px-4 mb-0 me-3">Save Rs. 48.00</p>
                ...
                <div class="carousel-banner">
                    <div class="carousel-banner-content text-center p-4">
                        ...
                        <del class="me-2 text-white fs-5">Rs. 1,250.00</del>
                        <span class="text-primary fs-5">Rs. 1,050.00</span>
                    </div>
            ...
            <div class="p-4">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-4">
                        ...
                        <p class="mb-0">Recieve gift all over oder Rs. 50</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                    ...
                    <img src="{{asset('assets/frontend/img/product-1.png')}}" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                    ...
                    <img src="{{asset('assets/frontend/img/product-2.png')}}" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5">
        <div class="tab-class">
            <div class="row g-4">
                ...
                <div class="col-lg-8 text-end wow fadeInRight" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex text-center mb-5">
                        ...
                        <li class="nav-item mb-4">
                            <a class="d-flex py-2 px-4 mx-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-{{$productCategory->id}}">
                                <span class="text-dark" style="width: 130px;">{{$productCategory->category_name}}</span>
                            </a>
                        </li>
                        @endforeach
            ...
            <div class="tab-content">
                            ...
                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-item-inner border rounded">
                                    <div class="product-item-inner-item">
                                        <img src="{{$product->image}}" class="img-fluid w-100 rounded-top" style="height:250px" alt="">
                                    ...
                                    <div class="text-center rounded-bottom p-4">
                                        <a href="{{route('productDetail',$product->slug)}}" class="d-block mb-2">{{$product->name}}</a>
                                        <a href="#" class="d-block h4">{{$product->productCategory->category_name}}</a>
                                        <del class="me-2 fs-5">Rs. {{$product->price}}</del>
                                        <span class="text-primary fs-5">Rs. {{$product->net_amount}}</span>
                                    </div>
                                </div>
                                <div
                ...
                @foreach($productCategories as $productCategory)
                <div id="tab-{{$productCategory->id}}" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        @foreach($productCategory->products as $product)
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-item-inner border rounded">
                                    <div class="product-item-inner-item">
                                        <img src="{{$product->image}}" class="img-fluid rounded-top" style="height:250px" alt="">
                                        <div class="product-new">New</div>
                                        <div class="product-details">
                                            <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                        </div>
            ...
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                <a href="#">
                    <div class="bg-primary rounded position-relative">
                        <img src="{{asset('assets/frontend/img/product-banner.jpg')}}" class="img-fluid w-100 rounded" alt="">
                        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                            style="background: rgba(255, 255, 255, 0.5);">
                            <h3 class="display-5 text-primary">EOS Rebel <br> <span>T7i Kit</span></h3>
                            <p class="fs-4 text-muted">Rs. 899.99</p>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                <a href="#">
                    <div class="text-center bg-primary rounded position-relative">
                        <img src="{{asset('assets/frontend/img/product-banner-2.jpg')}}" class="img-fluid w-100" alt="">
                        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
            ...
            <div class="productImg-carousel owl-carousel productList-item">
                <div class="productImg-item products-mini-item border">
                    <div class="row g-0">
                        <div class="col-5">
                            <div class="products-mini-img border-end h-100">
                                <img src="{{$product->image}}" class="img-fluid w-100 h-100" style="height:100px" alt="Image">
                        ...
                        <div class="col-7">
                            <div class="products-mini-content p-3">
                                <a href="{{route('productDetail',$product->slug)}}" class="d-block mb-2">{{$product->name}}</a>
                                <a href="{{route('productDetail',$product->slug)}}" class="d-block h4">{{$product->productCategory->category_name}}</a>
                                <del class="me-2 fs-5">Rs. {{$product->price}}</del>
                                <span class="text-primary fs-5">Rs. {{$product->net_amount}}</span>
                            </div>
                        </div>
                    ...
                    <div class="products-mini-add border p-3">
                        <a href="{{route('productDetail',$product->slug)}}" class="btn btn-primary border-secondary rounded-pill py-2 px-4"><i
                                class="fas fa-shopping-cart me-2"></i> Add To Cart</a>
                        <div class="d-flex">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                <div class="products-mini-item border">
                    <div class="row g-0">
                        <div class="col-5">
                            <div class="products-mini-img border-end h-100">
                                <img src="{{asset('assets/frontend/img/product-3.png')}}" class="img-fluid w-100 h-100" alt="Image">
                                <div class="products-mini-icon rounded-circle bg-primary">
                                    <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                </div>
                            </div>

         ...
         <div class="col-12">
             <div class="card overflow-hidden">
                 <div class="table-responsive p-5">
                     ...
                     <form action="{{route('admin.product.store')}}" method="POST" enctype="multipart/form-data" class="row g-4">
                         @csrf
                         <div class="col-md-12 row">
                             ...
                             <div class="mb-3 col-md-6">
                                 ...
                                 <input type="text" name="name" class="form-control" id="exampleInputbrand_name" aria-describedby="brand_nameHelp">
                                 <span class="text-warning">
                                     @error('name')
                                     {{$message}}
                                     @enderror
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" name="slug" class="form-control" id="exampleInputslug" aria-describedby="slugHelp">
                             <span class="text-warning">
                                 @error('slug')
                                 {{$message}}
                                 @enderror
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" name="discount" class="form-control" id="exampleInputdiscount" aria-describedby="discountHelp">
                             <span class="text-warning">
                                 @error('discount')
                                 {{$message}}
                                 @enderror
                         ...
                         <div class="mb-3">
                             <label for="exampleInputlogo" class="form-label">No of Itmes</label>
                             <input type="text" name="no_of_items" class="form-control" id="exampleInputno_of_items" aria-describedby="no_of_itemsHelp">
                             <span class="text-warning">
                                 @error('no_of_items')
                                 {{$message}}
                                 @enderror
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" name="color" class="form-control" id="exampleInputcolor" aria-describedby="colorHelp">
                             <span class="text-warning">
                                 @error('color')
                                 {{$message}}
                                 @enderror
